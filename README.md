...
All my GitHub stuff in one place — client websites, school projects, APIs, mobile apps, and random experiments.
...
[![Public repos](https://img.shields.io/badge/Public%20repos-26-blue?style=flat-square)](https://github.com/ferrannl?tab=repositories)
...
I’ve touched a lot of stacks over time — from low-level C/C++ to mobile apps and Node APIs.
...
<details>
<summary><strong>🌐 Websites (client work, guides, experiments)</strong></summary>

### 🏝 Cafetería Churrería San Pedro (Tenerife)

A modern promo site for a local cafeteria in Tenerife.  
- Repo: [Cafeteria-Churreria-San-Pedro](https://github.com/ferrannl/Cafeteria-Churreria-San-Pedro)  
- Live: https://ferrannl.github.io/Cafeteria-Churreria-San-Pedro/  
- Stack: `HTML`, `CSS`, `Vanilla JS`

---

### 💈 Elegant Barbershop (‘s-Hertogenbosch)

Website suggestion for a barbershop in the Netherlands.  
- Repo: [elegant-barbershop](https://github.com/ferrannl/elegant-barbershop)  
...
Landing page / suggestion site for a storage concept.  
- Repo: [meinlager](https://github.com/ferrannl/meinlager)  
...
JavaScript-based assignment game.  
- Repo: [Monsterzoo](https://github.com/ferrannl/Monsterzoo)  
- Live: https://ferrannl.github.io/Monsterzoo/  
...
Guide / documentation site for Phantasy Star Online-related stuff on Wii U.  
- Repo: [pso-wiiu-guide](https://github.com/ferrannl/pso-wiiu-guide)  
- Live: https://ferrannl.github.io/pso-wiiu-guide/  
- Stack: `HTML`, `CSS`
...
Website assignment based on the card game Munchkin.  
- Repo: [Munchkin](https://github.com/ferrannl/Munchkin)  
- Live: https://ferrannl.github.io/Munchkin/  
- Stack: `HTML`, `CSS`

---

### 🛒 Niks voor Niks Marketplace

PHP-based marketplace project.  
- Repo: [Niks-voor-Niks](https://github.com/ferrannl/Niks-voor-Niks)  
- Live: https://ferrannl.github.io/Niks-voor-Niks/  
- Stack: `PHP`, `HTML`, `CSS`
...
- Repo: [CodePen](https://github.com/ferrannl/CodePen)  
- Live: https://ferrannl.github.io/CodePen/  
...
<details>
<summary><strong>📱 Mobile Apps (Android & iOS)</strong></summary>

### 📷 Imgur App – iOS

An iOS client for Imgur.  
- Repo: [Imgur-App-iOS](https://github.com/ferrannl/Imgur-App-iOS)  
- Stack: `Swift`, `iOS`
...
Android client for Imgur, built as a final assignment.  
- Repo: [Imgur-App-Android](https://github.com/ferrannl/Imgur-App-Android)  
- Stack: `Java`, `Android`
...
NodeJS REST API that compares image similarity via Imagga.  
- Repo: [Image-Compare-API](https://github.com/ferrannl/Image-Compare-API)  
- Stack: `Node.js`, `REST`, `JavaScript`

---

### 📏 Address Distance Calculator

.NET / C# API case for calculating distance between addresses.  
- Repo: [Address-Distance-Calculator](https://github.com/ferrannl/Address-Distance-Calculator)  
- Stack: `.NET`, `C#`, `API`
...
DevOps-related project using TypeScript and tooling.  
- Repo: [DevOps](https://github.com/ferrannl/DevOps)  
...
<details>
<summary><strong>🎓 Study & Assignment Projects</strong></summary>

### 🧮 Linear Algebra (C)

Game-dev related linear algebra code.  
- Repo: [Linear-Algebra](https://github.com/ferrannl/Linear-Algebra)  
- Stack: `C`, `Math`, `Game Dev`

---

### 🔢 Sudoku – Design Patterns (C#)

Sudoku application demonstrating design patterns.  
- Repo: [Sudoku-Design-Patterns](https://github.com/ferrannl/Sudoku-Design-Patterns)  
- Stack: `C#`, `OOP`, `Design Patterns`

---

### 🐾 Speuren met Krul – 2020 / 2021 (C++)

Two versions of the *Speuren met Krul* assignment in C++.  
- Repo 2020: [Speuren-met-Krul-2020](https://github.com/ferrannl/Speuren-met-Krul-2020)  
- Repo 2021: [Speuren-met-Krul-2021](https://github.com/ferrannl/Speuren-met-Krul-2021)  
- Stack: `C++`

---

### 📝 Study-Mate (PHP Final Assignment)

School project built in PHP.  
- Repo: [Study-Mate](https://github.com/ferrannl/Study-Mate)  
- Stack: `PHP`, `HTML`, `CSS`
...
Final C++ assignment (CPPLS2).  
- Repo: [AvanSync](https://github.com/ferrannl/AvanSync)  
- Stack: `C++`

---

### 🏛 Dimitri (Software Architecture)

C++ project for Software Architecture.  
- Repo: [Dimitri](https://github.com/ferrannl/Dimitri)  
- Stack: `C++`, `Architecture`

---

### 🌱 Ecobit Internship

C# code from a third-year internship.  
- Repo: [Ecobit-Internship](https://github.com/ferrannl/Ecobit-Internship)  
- Stack: `C#`
...
Java project based on the classic board game.  
- Repo: [Kolonisten-van-Catan](https://github.com/ferrannl/Kolonisten-van-Catan)  
- Stack: `Java`
...
Fork of a large PS2 covers collection.  
- Repo: [ps2-covers](https://github.com/ferrannl/ps2-covers)  
...
I’m Ferran — I like building small, focused things:

- client websites for local businesses  
- guides & tools for my own nerdy interests (retro / gaming / PSO etc.)  
- lots of school assignments in different languages that somehow still live here 😅  

If you see anything interesting:  
- Feel free to open an issue, fork it, or ping me.  
- Or just **steal the ideas** and make them better.
